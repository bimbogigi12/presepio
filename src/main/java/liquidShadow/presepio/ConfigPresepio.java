...
public class ConfigPresepio {
	...
	public static Pin LED_MANGIATOIA = RaspiPin.GPIO_23;
	public static Pin LED_STELLA_CADENTE = RaspiPin.GPIO_00;
	...
	public static Pin LED_STAR1 = RaspiPin.GPIO_03;
	public static Pin LED_STAR2 = RaspiPin.GPIO_21;
	public static Pin LED_PONTE = RaspiPin.GPIO_22;
	public static Pin LED_CAPANNA = RaspiPin.GPIO_01;
	...
	public static Pin PIN_FIUME = RaspiPin.GPIO_27;
